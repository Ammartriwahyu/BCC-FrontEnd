  ...
  return (
    <section className="max-w-[1200px] mx-auto px-6 py-16 md:py-24 space-y-12 md:space-y-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <TrackingCard title="Tracking" description="Pantau progres bacaanmu dengan mudah. Tandai buku yang sedang dibaca, yang sudah selesai, atau yang ingin kamu baca nanti. Semua aktivitas membaca bisa terlihat dengan rapi dalam satu tempat." />
        <TrackingCard title="Add Friends" description="Tambahkan teman untuk melihat aktivitas membaca mereka, berbagi rekomendasi buku, dan menemukan bacaan baru dari orang lain." />
      </div>
